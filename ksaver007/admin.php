        ...
        <div class="container-form">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-dark">
                    <thead>
                        <tr>
                            <th class="textcolor">ФИО</th>
                            <th class="textcolor" class="mobile-hidden">Контакты</th>
                            <th class="textcolor">Инвентарь</th>
                            <th class="textcolor" class="mobile-hidden">Пункт выдачи</th>
                            <th class="textcolor">Период аренды</th>
                            <th class="textcolor" class="mobile-hidden">Сумма</th>
                            <th class="textcolor">Статус</th>
                            <th class="textcolor">Действия</th>
                        </tr>
                    </thead>
                    <tbody>
